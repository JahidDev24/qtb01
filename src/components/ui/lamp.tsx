...
<div
        ...
        >
            <div className="relative flex w-full h-12 flex-1 scale-y-125 items-center justify-center bg-gradient-conic from-purple-500 isolate z-0 ">
                ...
                <motion.div
                    ...
                    className="absolute inset-auto h-10 right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-purple-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
                >
                    <div className="absolute  w-[100%] bg-background left-0 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
            ...
            <div className="relative z-50 flex -translate-y-80 flex-col items-center px-3">
                {children}
            </div>
        </div>
